...
const TabsTrigger = React.forwardRef<HTMLButtonElement, TabsTriggerProps>(
  ({ value, asChild = false, ...props }, forwardedRef) => {
    ...
    // Expose localRef to forwardedRef
    ...
    return (
      <Component
        // IMPORTANT:
        // Only attach ref when NOT using Slot.
        // Slot cannot accept a button ref safely.
        ref={asChild ? undefined : localRef}
...
const TabsContent = React.forwardRef<HTMLDivElement, TabsContentProps>(
  ({ value, style, asChild = false, ...props }, forwardedRef) => {
    const { activeValue } = useTabs();
    ...
    return (
      <Component
        ...
        inert={!isActive}
        // ⬇⬇ FIX: Only attach ref if NOT using Slot ⬇⬇
        ref={asChild ? undefined : localRef}
