  ...
  return (
    <div>
      <div
        ...
        className="global-banner relative overflow-hidden bg-blue-normal w-4/5 m-auto rounded-md px-20 py-11 "
      >
        <motion.div
        ...
        />
        <div className="banner-cta relative z-10 text-white flex flex-col gap-5">
          <div>
          ...
          <button className="button-regular text-blue-normal bg-white rounded-md w-72 h-11">
